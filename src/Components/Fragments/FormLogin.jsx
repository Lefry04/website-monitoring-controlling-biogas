    ...
    return (
        <div className="bg-black/50 w-2/5 h-fit rounded-2xl p-15 text-start flex flex-col gap-8">
            ...
            <form onSubmit={handleLogin}>
                <Input type="email" label="Email" placeholder="Masukkan email anda" name="email" className="border border-white text-lg text-white" ukuran="mb-7" ref={emailRef} />
                <Input type="password" label="Kata Sandi" placeholder="Masukkan kata sandi anda" name="password" className="border border-white text-lg text-white" />
