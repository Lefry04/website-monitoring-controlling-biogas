...
//     const [time, setTime] = useState(10); // simulasi 10 detik (ubah ke 300 utk 5 menit)
//     const [firebaseControl, setFirebaseControl] = useState("");
...
//             if (data) {
//                 setFirebaseControl(data.control || "-");
...
//             setIsActive(false);
//             setTime(10);
//             update(ref(db, "motor"), { status: "OFF" });
//         }
...
//                             <div className="flex items-center justify-between w-full h-full p-2 rounded-2xl transition-all duration-300 bg-white">
//                                 <div
//                                     className={`flex items-center justify-center w-1/2 h-full rounded-2xl text-lg font-semibold cursor-default transition-all duration-300 ${isActive ? "bg-transparent text-black/30" : "bg-gray-500 text-white shadow-inner"
//                                         }`}
//                                 >
//                                     Mati
//                                 </div>
...
//                                     disabled={isActive}
//                                     className={`flex items-center justify-center w-1/2 text-lg font-semibold cursor-pointer transition-all duration-300 ${isActive ? "font-bold bg-gray-500 text-white hover:cursor-default" : "text-black/70"
//                                         } rounded-2xl h-full`}
//                                 >
//                                     Aktif
//                                 </button>
...
//                             Pengaduk biogas beroperasi maksimal 5 menit setiap kali dinyalakan, tidak dapat dimatikan manual.
//                             Jika tidak dinyalakan, sistem akan otomatis menyala setiap 12 jam sekali.
//                         </p>
//                         <p className="text-xs text-gray-500 mt-1">
//                             <b>Firebase Control:</b> {firebaseControl} | <b>Status:</b> {firebaseStatus}
//                         </p>
//                     </div>
//                 </div>
